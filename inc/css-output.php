 ...
 * @since 2.0
 */
function child_generate_no_cache_dynamic_css() {
	$css = new GeneratePress_CSS();
...
add_action( 'wp_enqueue_scripts', 'child_generate_enqueue_dynamic_css', 50 );
/**
 * Enqueue our dynamic CSS.
 *
 * @since 2.0
 */
function child_generate_enqueue_dynamic_css() {
...
add_action( 'init', 'child_generate_set_dynamic_css_cache' );
/**
 ...
 * @since 2.0
 */
function child_generate_set_dynamic_css_cache() {
...
add_action( 'customize_save_after', 'child_generate_update_dynamic_css_cache' );
/**
